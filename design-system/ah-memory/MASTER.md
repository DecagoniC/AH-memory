...
Apple-inspired workspace override of the generated teal/orange set: monochrome surfaces, a single system-blue CTA, hairline borders, no gradients, no glass.

**Light**

| Role | Hex | CSS Variable |
|------|-----|--------------|
| Primary | `#1D1D1F` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Accent/CTA | `#0071E3` | `--color-accent` |
...
**Color Notes:** Knowledge-base neutrals + Apple system blue. Muted text uses `#6E6E73` (not `#86868B`) to keep 4.5:1 on white.
...
- ❌ Complex onboarding
- ❌ Slow performance
- ❌ Gradients (radial, linear, mesh) on chrome, backgrounds, or buttons
- ❌ Liquid glass / `backdrop-filter` / translucent panels
- ❌ Heavy drop shadows as a substitute for hierarchy
