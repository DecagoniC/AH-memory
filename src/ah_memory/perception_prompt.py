...
- wm_context содержит ограниченные ранжированные карточки ранее известных
  сущностей. Используй их только для разрешения ссылок и неоднозначных
  упоминаний. Не извлекай из них новые факты и не подменяй ими текущий текст.
- Порядок wm_context соответствует убыванию релевантности.
